...
public:
    ActionContext()
    {
        ...
        creators["new rpg leave open water"] = &ActionContext::new_rpg_leave_open_water;
...
private:
    ...
    static Action* new_rpg_leave_open_water(PlayerbotAI* ai) { return new NewRpgLeaveOpenWaterAction(ai); }
